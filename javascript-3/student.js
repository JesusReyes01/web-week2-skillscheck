...
// Code Here
let groceries = ["tequila", "limes","salt"]
//////////////////STEP 2////////////////////
...
let checkGroceryCount = () => {
    numberOfGroceries = groceries.length
    if(numberOfGroceries >= 5){  return `That looks like a big trip`}
    else if(numberOfGroceries === 1){return `1 item`}
    else if(numberOfGroceries > 1 && numberOfGroceries < 5){return `${numberOfGroceries} items`}
}
//////////////////STEP 6////////////////////
