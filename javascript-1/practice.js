...
//Code here
let lovesCode = true; //let for a reason *laughing emoji*
//////////////////PROBLEM 4////////////////////
...
//Code Here
let me = {firstName: "Jesus", state: `Texas`,age: 31,greeter: (name, state) => {return `Hello! My name is ${name} and I live in ${state}`} }
//////////////////PROBLEM 12////////////////////
...
// Code Here
let total = myNumbers.reduce( (acc,el) => acc + el)
//////////////////PROBLEM 17////////////////////
...
// let enemies = people.filter(({el}) => friend !== true)
//////////////////PROBLEM 20////////////////////
...
// Code Here
let totallyAwesome = people.reduce( (acc,{awesomeLevel}) => acc + awesomeLevel,0)
